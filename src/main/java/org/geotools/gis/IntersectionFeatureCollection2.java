...
public class IntersectionFeatureCollection2 {//implements GSProcess{
    ...
    public SimpleFeatureCollection execute(SimpleFeatureCollection firstFeatures,
            SimpleFeatureCollection secondFeatures) throws Exception {
        if (!(firstFeatures.features().next().getDefaultGeometry() instanceof MultiPolygon)
            ...
            throw new Exception("First feature collection must be polygonal or linear");
        } else {
